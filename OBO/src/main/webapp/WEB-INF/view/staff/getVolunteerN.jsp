					...
					<div class="blog_right_sidebar">
						<aside class="single_sidebar_widget post_category_widget category_setting">
							<ul class="list cat-list">
								<li>
									<a href="${pageContext.request.contextPath}/staff/getVolunteerN" class="d-flex"><p>일반봉사</p></a>
								</li>
								<li>
									<a href="${pageContext.request.contextPath}/staff/getVolunteerP" class="d-flex"><p>정기봉사</p></a>
								</li>
								<li>
									<a href="#" class="d-flex"><p>그외추가</p></a>
								</li>
							</ul>
						</aside>
					</div>
