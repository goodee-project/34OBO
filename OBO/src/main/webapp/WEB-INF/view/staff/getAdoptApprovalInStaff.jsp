								...
								<c:forEach var="a" items="${adoptApprovalList}">
									<tr>
										...
										<td style="text-align:center;">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#carePlan-modal" onclick="carePlanFunc('${a.animalName}','${a.animalId}', '${a.memberId}', '${a.adoptDate}');">
						...
						<nav class="blog-pagination justify-content-center d-flex">
							<ul class="pagination">
								...
								<c:if test="${currentPage > 1}">
									<li class="page-item"><a href="${pageContext.request.contextPath}/staff/getAdoptApprovalInStaff?currentPage=${currentPage-1}
