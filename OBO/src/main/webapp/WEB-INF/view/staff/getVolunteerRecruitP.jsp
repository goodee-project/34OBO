...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-9 mb-5 mb-lg-0">
						...
						<div class="blog_details">
							<div>
								...
								<c:if test="${categoryName != null || (searchSelect != null && searchWord != null)}">
									검색결과 &nbsp;<a href="${pageContext.request.contextPath}/staff/getVolunteerRecruitP"><button class="btn" type="reset"><i class="fa fa-refresh"></i></button></a>
								</c:if>
							</div>
							<br>
							...
							<table class="table">
								...
								<c:forEach var="v" items="${volunteerRecruitP}">
									<tr>
										<td>${v.staffId}</td>
					...
					<div class="blog_left_sidebar">
						...
						<nav class="blog-pagination justify-content-center d-flex">
							<ul class="pagination">
								...
								<c:if test="${currentPage > 1}">
									<li class="page-item"><a href="${pageContext.request.contextPath}/staff/getVolunteerRecruitP?currentPage=${currentPage-1}&categoryName=${categoryName}
						...
						<!-- 검색 -->
						<form id="searchForm" action="${pageContext.request.contextPath}/staff/getVolunteerRecruitP">
					...
					<form id="addForm" action="${pageContext.request.contextPath}/staff/addVolunteerRecruitP" method="post">
						<table class="table">
							...
							<tr>
								<td>시작일</td>
								<td>
									<input id="periodVolunteerStartDate" name="periodVolunteerStartDate" type="date" class="form-control">
								</td>
							</tr>
							<tr>
								<td>봉사주기</td>
								<td>
									<select name="volunteerCycle" class="select_box">
	...
	function addVolunteerFunc(){
		...
		} else if($('#periodVolunteerStartDate').val() == ''){
			alert('시작일을 선택하세요');
			$('#periodVolunteerStartDate').focus();
		} else if($('#volunteerCycle').val() == ''){
			alert('봉사주기를 선택하세요');
			$('#volunteerCycle').focus();
